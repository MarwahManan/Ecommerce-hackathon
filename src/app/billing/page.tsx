...
import I1 from "/public/dashboard/Look.png";
import I2 from "/public/Review.png"; 
        ...
        <div className='order-2 lg:order-1'>
            ...
            <div className='w-full bg-white p-2 mt-2 rounded-lg mx-auto lg:mx-0'>
                ...
                <div className='w-fit mt-4'>
                  <Link href="/">  <button className='bg-[rgba(53,99,233,100%)] text-white px-6 py-3 rounded-lg'>Rent Now</button>
                  </Link>
                </div>
